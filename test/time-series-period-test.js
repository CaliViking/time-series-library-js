...
describe('time-series-period', function () {
  describe('TimeSeries("number", "linear")', function () {
    ...
    describe('resample()', function () {
      ...
      testPeriod1.setTimeVector(Array.from(Array(arrayLength).keys()), Array.from(Array(arrayLength).keys()), Array.from({length: arrayLength}, (_v, _k) => 0));
    ...
    describe('add()', function () {
      ...
      describe('TSP', function () {
        ...
        it(`should have timestamp ${testLocation / 2} in location ${testLocation} when TSP add`, function () {
        ...
        it(`should have timestamp ${(testLocation + 1) / 2} in location ${testLocation + 1} when TSP add`, function () {
          equal(testPeriod3.timestamps[testLocation + 1], (testLocation + 1) / 2);
        });
        it(`should have value ${testLocation + 1} in location ${testLocation + 1} when TSP add`, function () {
      ...
      describe('Scalar number', function () {
        ...
        it(`should have timestamp ${testLocation / 2} in location ${testLocation} when scalar add`, function () {
          equal(testPeriod3.timestamps[testLocation], testLocation / 2);
        });
        it(`should have value ${testLocation/2 + testScalarValue} in location ${testLocation} when scalar add`, function () {
          equal(testPeriod3.values[testLocation], testLocation/2 + testScalarValue);
        });
        it(`should have timestamp ${(testLocation + 1) / 2} in location ${testLocation + 1} when scalar add`, function () {
          equal(testPeriod3.timestamps[(testLocation + 1)], (testLocation + 1) / 2);
        });
        it(`should have value ${(testLocation + 1)/2 + testScalarValue} in location ${(testLocation + 1)} when scalar add`, function () {
    ...
    describe('subtract()', function () {
      ...
      describe('TSP', function () {
        ...
        it(`should have timestamp ${testLocation / 2} in location ${testLocation} when TSP subtract`, function () {
          equal(testPeriod3.timestamps[testLocation], testLocation / 2);
        });
        it(`should have value ${0} in location ${testLocation} when TSP subtract`, function () {
          equal(testPeriod3.values[testLocation], 0);
        });
        it(`should have timestamp ${(testLocation + 1) / 2} in location ${testLocation + 1} when TSP subtract`, function () {
          equal(testPeriod3.timestamps[testLocation + 1], (testLocation + 1) / 2);
        });
      ...
      describe('Scalar number', function () {
        ...
        it(`should have timestamp ${testLocation / 2} in location ${testLocation} when scalar subtract`, function () {
          equal(testPeriod3.timestamps[testLocation], testLocation / 2);
        });
        it(`should have value ${testLocation/2 - testScalarValue} in location ${testLocation} when scalar subtract`, function () {
          equal(testPeriod3.values[testLocation], testLocation/2 - testScalarValue);
        });
        it(`should have timestamp ${(testLocation + 1) / 2} in location ${testLocation + 1} when scalar subtract`, function () {
          equal(testPeriod3.timestamps[(testLocation + 1)], (testLocation + 1) / 2);
        });
        it(`should have value ${(testLocation + 1)/2 - testScalarValue} in location ${(testLocation + 1)} when scalar add`, function () {
          equal(testPeriod3.values[(testLocation + 1)], (testLocation + 1)/2 - testScalarValue);
      ...
      describe('Scalar string', function () {
        ...
        it(`should have value ${(testLocation + 1)/2 - testScalarValue} in location ${(testLocation + 1)} when scalar subtract`, function () {
          equal(testPeriod3.values[(testLocation + 1)], (testLocation + 1)/2 - testScalarValue);
        });
      });
    ...
    describe('multiply()', function () {
      ...
      describe('TSP', function () {
        ...
        it(`should have value ${testLocation/2 * testLocation/2} in location ${testLocation} when TSP multiply`, function () {
      ...
      describe('Scalar number', function () {
        ...
        it(`should have value ${testLocation/2 * testScalarValue} in location ${testLocation} when scalar multiply`, function () {
          equal(testPeriod3.values[testLocation], testLocation/2 * testScalarValue);
        });
      });
    ...
    describe('divide()', function () {
      ...
      describe('Scalar number', function () {
        ...
        it(`should have value ${testLocation/2 / testScalarValue} in location ${testLocation} when scalar divide`, function () {
          equal(testPeriod3.values[testLocation], testLocation/2 / testScalarValue);
        });
      });
    ...
    describe('pow()', function () {
      ...
      describe('TSP', function () {
        ...
        it(`should have value ${(testLocation/2)**(testLocation/2)} in location ${testLocation} when TSP pow`, function () {
          equal(testPeriod3.values[testLocation], (testLocation/2)**(testLocation/2));
        });
      });
      ...
      describe('Scalar number', function () {
        ...
        it(`should have value ${(testLocation/2) ** testScalarValue} in location ${testLocation} when scalar pow`, function () {
          equal(testPeriod3.values[testLocation], (testLocation/2) ** testScalarValue);
        });
      });
    ...
    describe('remainder()', function () {
      ...
      describe('TSP', function () {
        ...
        it(`should have value ${(testLocation/2)%(testLocation/2)} in location ${testLocation} when TSP remainder`, function () {
          equal(testPeriod3.values[testLocation], (testLocation/2)%(testLocation/2));
        });
      });
      ...
      describe('Scalar number', function () {
        ...
        it(`should have value ${(testLocation/2) % testScalarValue} in location ${testLocation} when scalar remainder`, function () {
          equal(testPeriod3.values[testLocation], (testLocation/2) % testScalarValue);
        });
      });
