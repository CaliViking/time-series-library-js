...
import { Vector, TimestampsClass, ValueArrayType, StatusesClass, FloatDataType } from './vector.js';
...
describe('Vector', function () {
  ...
  describe('concat', function () {
    const testEmptyPeriod1 = new Vector<Float64Array>({ dataType: FloatDataType, length: 0 });
