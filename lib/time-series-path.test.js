...
describe('time-series-path', function () {
    ...
    describe('TimeSeriesPath', function () {
        ...
        describe('setTimeVector()', function () {
            ...
            beforeAll(function () {
                testPeriod.setTimeVector(Array.from(Array(arrayLength).keys()), Array.from(Array(arrayLength).keys()), Array.from({ length: arrayLength }, () => Severity.Good));
            });
        ...
        describe('resample() linear', function () {
            ...
            const expectedResampleValues = Array.from(Array(arrayLength * 4).keys()).map((v) => (v <= (arrayLength - 1) * 4 ? v * 0.25 : null) // The last values are outside the original array, therefore they are NULL
            );
            testPeriod1.setTimeVector(originalTimestamps, originalValues, Array.from({ length: arrayLength }, () => Severity.Good));
        ...
        describe('resample() previous', function () {
            ...
            // Resample to 4 times the original frequency
            const expectedResampleValues = Array.from(Array(arrayLength * 4 + 2).keys()).map((v) => v >= 1 && v <= arrayLength * 4
        ...
        describe('resample() next', function () {
            ...
            const resampleTimestamps = Array.from(Array(arrayLength * 4 + 2).keys()).map((v) => v); // Make sure the timestamps are outside the original array
            // Resample to 4 times the original frequency
            const expectedResampleValues = Array.from(Array(arrayLength * 4 + 2).keys()).map((v) => v >= 1 && v <= (arrayLength - 1) * 4 + 1
        ...
        describe('resample() none', function () {
            ...
            const resampleTimestamps = Array.from(Array(arrayLength * 4 + 2).keys()).map((v) => v); // Make sure the timestamps are outside the original array
            // Resample to 4 times the original frequency
            const expectedResampleValues = Array.from(Array(arrayLength * 4 + 2).keys()).map((v) => v >= 1 && v <= (arrayLength - 1) * 4 + 1 ? ((v - 1) % 4 === 0 ? (v - 1) / 4 : null) : null);
            testPeriod1.setTimeVector(originalTimestamps, originalValues, Array.from({ length: arrayLength }, () => Severity.Good));
            const testPeriod2 = testPeriod1.resample(resampleTimestamps);
            test(`should have expected members after resampling`, function () {
                expect(JSON.stringify(testPeriod2.values)).toBe(JSON.stringify(expectedResampleValues));
        ...
        describe('add()', function () {
            describe('TSP', function () {
                ...
                beforeAll(function () {
                    testPeriod1.setTimeVector(Array.from(Array(arrayLength).keys()), Array.from(Array(arrayLength).keys()), Array.from({ length: arrayLength }, () => Severity.Good));
                ...
                test(`should have timestamp ${(testLocation + 1) / 2} in location ${testLocation + 1} when TSP add`, function () {
            ...
            describe('Scalar number', function () {
                ...
                test(`should have value ${testLocation / 2 + testScalarValue} in location ${testLocation} when scalar add`, function () {
                    expect(testPeriod3.values[testLocation]).toBe(testLocation / 2 + testScalarValue);
                });
                test(`should have timestamp ${(testLocation + 1) / 2} in location ${testLocation + 1} when scalar add`, function () {
                    expect(testPeriod3.timestamps[testLocation + 1]).toBe((testLocation + 1) / 2);
                });
                test(`should have value ${(testLocation + 1) / 2 + testScalarValue} in location ${testLocation + 1} when scalar add`, function () {
        ...
        describe('subtract()', function () {
            describe('TSP', function () {
                ...
                test(`should have timestamp ${(testLocation + 1) / 2} in location ${testLocation + 1} when TSP subtract`, function () {
                    expect(testPeriod3.timestamps[testLocation + 1]).toBe((testLocation + 1) / 2);
                });
            ...
            describe('Scalar number', function () {
                ...
                test(`should have value ${testLocation / 2 - testScalarValue} in location ${testLocation} when scalar subtract`, function () {
                    expect(testPeriod3.values[testLocation]).toBe(testLocation / 2 - testScalarValue);
                });
                test(`should have timestamp ${(testLocation + 1) / 2} in location ${testLocation + 1} when scalar subtract`, function () {
                    expect(testPeriod3.timestamps[testLocation + 1]).toBe((testLocation + 1) / 2);
                });
                test(`should have value ${(testLocation + 1) / 2 - testScalarValue} in location ${testLocation + 1} when scalar add`, function () {
                    expect(testPeriod3.values[testLocation + 1]).toBe((testLocation + 1) / 2 - testScalarValue);
        ...
        describe('multiply()', function () {
            describe('TSP', function () {
                ...
                test(`should have value ${((testLocation / 2) * testLocation) / 2} in location ${testLocation} when TSP multiply`, function () {
            ...
            describe('Scalar number', function () {
                ...
                test(`should have value ${(testLocation / 2) * testScalarValue} in location ${testLocation} when scalar multiply`, function () {
                    expect(testPeriod3.values[testLocation]).toBe((testLocation / 2) * testScalarValue);
                });
            });
        });
        describe('divide()', function () {
            ...
            describe('Scalar number', function () {
                ...
                test(`should have value ${testLocation / 2 / testScalarValue} in location ${testLocation} when scalar divide`, function () {
                    expect(testPeriod3.values[testLocation]).toBe(testLocation / 2 / testScalarValue);
                });
            });
        });
        describe('pow()', function () {
            describe('TSP', function () {
                ...
                test(`should have value ${Math.pow((testLocation / 2), (testLocation / 2))} in location ${testLocation} when TSP pow`, function () {
                    expect(testPeriod3.values[testLocation]).toBe(Math.pow((testLocation / 2), (testLocation / 2)));
                });
            });
            describe('Scalar number', function () {
                const testPeriod1 = new TimeSeriesPath(DataType.number, InterpolationMethod.linear);
                ...
                test(`should have value ${Math.pow((testLocation / 2), testScalarValue)} in location ${testLocation} when scalar pow`, function () {
                    expect(testPeriod3.values[testLocation]).toBe(Math.pow((testLocation / 2), testScalarValue));
                });
            });
        });
        describe('remainder()', function () {
            describe('TSP', function () {
                ...
                test(`should have value ${(testLocation / 2) % (testLocation / 2)} in location ${testLocation} when TSP remainder`, function () {
                    expect(testPeriod3.values[testLocation]).toBe((testLocation / 2) % (testLocation / 2));
                });
            });
            describe('Scalar number', function () {
                ...
                test(`should have value ${(testLocation / 2) % testScalarValue} in location ${testLocation} when scalar remainder`, function () {
                    expect(testPeriod3.values[testLocation]).toBe((testLocation / 2) % testScalarValue);
                });
            });
        });
