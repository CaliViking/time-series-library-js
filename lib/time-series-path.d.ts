...
export declare class TimeSeriesPath<ThisValueType extends ValueArrayType> {
     ...
     * @returns
     */
    newVectorFromElements(timestamps: TimestampArrayClass, values: ThisValueType, statuses?: StatusArrayClass): TimeSeriesPath<ThisValueType>;
    /**
     ...
     */
    mutableResample(targetTimestamps: TimestampArrayClass): TimeSeriesPath<ThisValueType>;
    /**
     * Resamples and returns a new TimeSeriesPath (does not mutilate)
     * @param targetTimestamps The timestamps for resampling
     * @returns A new TimeSeriesPath
     */
    resample(targetTimestamps: TimestampArrayClass): TimeSeriesPath<ThisValueType>;
    /**
