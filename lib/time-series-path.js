...
import { BooleanDataType, FloatDataType, TimestampsClass, Vector } from './vector.js';
...
export class TimeSeriesPath {
  ...
  */
    ...
    arithmeticOperatorTS(operator, arg) {
        ...
        const targetVector = new Vector({ dataType: FloatDataType, length: targetTimestamps.length });
