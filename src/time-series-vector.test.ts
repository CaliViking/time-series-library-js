...
describe('TimeSeriesVector', function () {
  ...
  describe('append', function () {
    ...
    let resultPeriod0: TimeSeriesVector;
    ...
    beforeAll(function () {
      ...
      testPeriod2.set(
        ...
        Array.from({ length: arrayLength }, () => 2),
        Array.from({ length: arrayLength }, () => Severity.Good)
      );
      ...
      testPeriod3.set(
        ...
        Array.from({ length: arrayLength }, () => 4),
        Array.from({ length: arrayLength }, () => Severity.Good)
      );
  ...
  describe('multiAppend', function () {
    const testPeriods = [];
    let resultPeriod: TimeSeriesVector;
  ...
  describe('replace', function () {
    ...
    let resultEmptyPeriod0: TimeSeriesVector;
    ...
    beforeAll(function () {
      ...
      insidePeriod4.set(
        Array.from(Array(Math.floor(arrayLength / 2))).map((_v, k) => Math.floor(arrayLength / 4) * 10 + k * 10),
        Array.from({ length: Math.floor(arrayLength / 2) }, () => 6),
        Array.from({ length: Math.floor(arrayLength / 2) }, () => Severity.Good)
      );
      // Create earlyOverlappingPeriod5 so that it does overlap and is before testPeriod1
      earlyOverlappingPeriod5.set(
        Array.from(Array(arrayLength)).map((_v, k) => -Math.floor(arrayLength / 2) * 10 + k * 10),
        Array.from({ length: arrayLength }, () => 7),
        Array.from({ length: arrayLength }, () => Severity.Good)
      );
  ...
  describe('split', function () {
    const testPeriod1 = new TimeSeriesVector();
    let resultPeriods500: TimeSeriesVector[];
    let resultPeriods1000: TimeSeriesVector[];
  ...
  describe('slice', function () {
    const testPeriod1 = new TimeSeriesVector();
    let resultIncludeOverflowOnTarget: TimeSeriesVector;
    let resultIncludeOverflowOffTarget: TimeSeriesVector;
    let resultExcludeOverflowOnTarget: TimeSeriesVector;
    let resultExcludeOverflowOffTarget: TimeSeriesVector;
    let resultIncludeOverflowOutside: TimeSeriesVector;
    let resultExcludeOverflowOutside: TimeSeriesVector;
    const arrayLength = 10000;
